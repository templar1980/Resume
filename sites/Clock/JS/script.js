...
function runClock(){
	...
	var arrDegMinutesSeconds=[], arrDegHours=[];

	// ассоциативные массивы с градусами для rotate для минут, секунд и часов
	...
	return function() {
		...
		document.querySelector('.electro-hours').textContent = date.getHours();
